...
export default function CareersPage() {
  ...
  const Banner = ({ href }: { href: string }) => (
    <Link
      href={href}
      target="_blank"
      rel="noopener noreferrer"
      className="block rounded-2xl overflow-hidden border border-slate-200 hover:border-[#E5B85C] hover:shadow-lg transition-all duration-300"
    >
    ...
    <section className="bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#072828] via-[#0A2A2A] to-[#072828] text-white pt-14 pb-20 px-4 md:px-12 overflow-hidden rounded-b-[1.5rem]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Join a team that Delivers Premium Legal Info at every PIN Code.
          </motion.p>
        </div>
      </div>
      ...
      <div className="w-full px-4 md:px-4 py-12 md:py-20">
        ...
        <div className="hidden lg:flex gap-3 md:gap-4">
          {/* Left Banner */}
          <aside className="flex-1 min-w-[14rem] max-w-[20rem]">
          ...
          <div className="flex-shrink-0 w-full max-w-3xl">
            <AccordionPanels
              ...
              toggle={toggle}
              advFile={advFile}
              advFileRef={advFileRef}
              advUrl={advUrl}
              handleAdvFileChange={handleAdvFileChange}
              removeAdvFile={removeAdvFile}
              handleAdvUrlChange={handleAdvUrlChange}
              internFile={internFile}
              internFileRef={internFileRef}
              internUrl={internUrl}
              handleInternFileChange={handleInternFileChange}
              removeInternFile={removeInternFile}
              handleInternUrlChange={handleInternUrlChange}
            />
        ...
        <div className="lg:hidden">
          ...
          {/* Banners below – side by side on tablet, stacked on mobile */}
...
// ---------- Accordion Panels (extracted to avoid duplication) ----------
function AccordionPanels({
  ...
  internFileRef,
  internUrl,
  handleInternFileChange,
  removeInternFile,
  handleInternUrlChange,
}: any) {
  return (
    <>
