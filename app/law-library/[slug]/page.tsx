  ...
  return (
    <section className="py-16 px-4 md:px-12 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto">
        <Link href="/law-library" className="inline-flex items-center gap-2 text-sm text-slate-600 hover:text-amber-600 mb-8">
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 text-center">
          <Link href="/law-library" className="text-amber-600 hover:underline text-sm">
